 ...
 * creates the Stripe Checkout session with ITS OWN keys (managed at
 * https://license-service.etechflow.com/admin/subscriptions) and returns the
 * redirect URL. No payment keys live in Magento.
 */
class Checkout extends Action
{
    ...
    public function execute(): ResultInterface
    {
        ...
        $gate = $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('etechflow_faq/license/gate');
        ...
        $payload = json_encode([
            ...
            'magento_callback' => $this->getUrl('etechflow_faq/license/activated'),
            'magento_cancel'   => $this->getUrl('etechflow_faq/license/gate'),
        ]);
