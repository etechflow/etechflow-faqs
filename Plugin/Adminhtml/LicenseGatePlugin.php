...
namespace Etechflow\Faq\Plugin\Adminhtml;
 ...
 *
 * Registered in etc/adminhtml/di.xml against each concrete FAQ admin
 * controller class. When licence is invalid, short-circuits the
 * controller dispatch and redirects to /admin/etechflow_faq/license/gate.
 *
...
class LicenseGatePlugin
{
    ...
    public function aroundDispatch(Action $subject, callable $proceed, RequestInterface $request)
    {
        if (!$this->licenseValidator->isValid()) {
            ...
            $redirect->setPath('etechflow_faq/license/gate');
            return $redirect;
        }
