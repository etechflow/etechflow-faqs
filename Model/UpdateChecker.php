...
class UpdateChecker
{
    private const PACKAGE     = 'etechflow/module-faq';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-faq.json';
    private const CACHE_KEY   = 'etechflow_faq_update_check';
    private const CACHE_TTL   = 21600;
    private const MODULE_NAME = 'Etechflow_Faq';
