...
/**
 * License validation for Etechflow_Faq.
 *
...
{
    public const XML_PATH_LICENSE_KEY            = 'etechflow_faq/license/license_key';
    public const XML_PATH_ISSUED_KEY             = 'etechflow_faq/license/issued_key';
    public const XML_PATH_ISSUED_AT              = 'etechflow_faq/license/issued_at';
    public const XML_PATH_IP_BLOCKED             = 'etechflow_faq/license/ip_blocked';
    public const XML_PATH_PORTAL_URL             = 'etechflow_faq/license/portal_url';
    public const XML_PATH_PRODUCTION_ENVIRONMENT = 'etechflow_faq/license/production_environment';
    ...
    private const CACHE_TAG    = 'ETECHFLOW_FAQ';
    private const CACHE_PREFIX = 'etf_faq_lic_';

    /** Unique per-module HMAC secret. Fresh for FAQ v1.1.0 (greenfield). */
    private const MODULE_ID = 'faq';
