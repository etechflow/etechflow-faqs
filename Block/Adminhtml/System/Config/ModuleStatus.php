...
namespace Etechflow\Faq\Block\Adminhtml\System\Config;
...
/**
 * Status banner at the top of the FAQ / Help Centre admin config section.
 *
        ...
        if (!$licenceValid) {
            if (!$hasKey) {
                return $this->banner(
                    ...
                    . '<a href="' . $this->getUrl('etechflow_faq/license/gate') . '" style="color:inherit;text-decoration:underline;">License &amp; Plans</a> '
